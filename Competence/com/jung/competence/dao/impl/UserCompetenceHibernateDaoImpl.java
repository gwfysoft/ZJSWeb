...
//		}
	...
	public void deleteRoleForUser(Integer roleID) {
		String sql = "delete from roleforuser where roleID=" + roleID;
		try {
			super.executeSQLUpdate(sql);
		} catch (SkeletonException e) {
	...
	public boolean updateRoleForUser(String roleName,int roleID){
		String sql="update roleforuser set roleSimp='"+roleName+"'"+" where roleID="+roleID;
		try {
			super.executeSQLUpdate(sql);
			return true;
		} catch (SkeletonException e) {
