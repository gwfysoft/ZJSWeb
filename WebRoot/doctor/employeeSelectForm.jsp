...
if(type){
	 commonQuery = ctxPath + "/common/entityList.action?entityName=Employee"+"&queryConditions[\"employeeType\"]="+<%=request.getParameter("type")%>;
}else{
	 commonQuery = ctxPath + "/common/entityList.action?entityName=Employee";
}
