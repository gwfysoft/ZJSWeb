	...
	<%@ include file="/commons/jsp/common_js.jsp"%>
	 <div class="container">
                <div class="row links-horizontal">
					<div id="modal-backdrop-middle"></div>
					<div id="modal-backdrop-small"></div>
					<div id="modal-backdrop-hospital"></div>
					<div class="ufo-fixed-table" id="zhai-middle-area">
				           <table id="zhai-middle-area-table"></table>
				           <div id="zhai-middle-area-table-pager"></div>
				    </div>
				    <div class="ufo-fixed-table" id="zhai-small-area">
				        <table id="zhai-small-area-table"></table>
				        <div id="zhai-small-area-table-pager"></div>
				    </div>
				    <div class="ufo-fixed-table" id="zhai-hospital-area">
				        <table id="zhai-hospital-area-table"></table>
				        <div id="zhai-hospital-area-table-pager"></div>
				    </div>
		 		</div>
		 </div>
	<script>
			jQuery(function() {
				...
				jQuery("#integralStatisticsTable").jqGrid({
					...
					datatype : "local",
					colNames : ['id', '区域名', '兑换总积分', '兑换总产品数', '兑换总人数', '兑换期数'],
					colModel : [{
						name : 'id',
						index : 'id',
						label : '主键ID',
